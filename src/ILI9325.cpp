...
std::array<ILI9325::InitCmd, 48> ILI9325::ILI9235_init = { ILI9325::InitCmd { ILI9325_REG::ILI9325_StartOdc, 0x001 }, { ILI9325_REG::WAIT, 50 }, { ILI9325_REG::ILI9325_DriverOutControl, 0x0100 }, {
        ILI9325_REG::ILI9325_LCDDriverControl, 0x0700 }, { ILI9325_REG::ILI9325_EntryMode, 0x1030 }, { ILI9325_REG::ILI9325_ResizeCtrl, 0x0000 },
...
//        { ILI9325_REG::S6D0129_PowerCtrl3, 0x0070 },
...
//        { ILI9325_REG::ILI9325_EntryMode, 0x8030 },
...
//        { ILI9325_REG::ILI9325_DisplCtrl1, 0x0017 }
//};
...
void ILI9325::initS6D0129() {
    ...
    ILI9325_RamRW::write(Color6Bit(0,0,0), DEFAULT_HEIGTH * DEFAULT_WIDTH);
//    ILI9325_DisplCtrl1::write(0x0017);
}
